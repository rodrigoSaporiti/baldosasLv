...
function renderizarMosaicos(data) {
  data.forEach((element, index) => {
    contenedorCards.innerHTML += `
      ...
      <a class="m-0 p-0 text-black text-decoration-none" href="veredaBaldosa.html?id=${element.id}">

      <img src="secciones/vereda/${element.img}" alt="Baldosa de vereda ${element.titulo}">
