...
function traerDataLisas(data) {
 ...
 textSKU.forEach(element => { element.textContent = `${mosaico.titulo}`;
  ...
  classCImagenP.innerHTML=`
   ...
   <a href="secciones/piscina/${mosaico.img}" id="enlaceImagen" data-fancybox="gallery" class="m-0 p-0">
    <img id="contenedorImagenPrincipal" src="secciones/piscina/${mosaico.img}" alt="Baldosa de piscina">
  </a>
